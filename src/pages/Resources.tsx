          ...
          {activeTab === 'books' && (
            ...
            >
              {books.map((book, index) => (
                <div key={index} className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                  <div className="mb-4">
          ...
          {activeTab === 'articles' && (
            ...
            >
              {articles.map((article, index) => (
                <div key={index} className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
