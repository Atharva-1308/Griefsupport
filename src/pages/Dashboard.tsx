  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-purple-600 to-blue-600 text-white p-8 rounded-xl shadow-lg"
      >
      ...
      >
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Continue Your Journey</h2>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              <TrendingUp className="h-6 w-6 text-purple-600" />
              <div>
                <h3 className="font-semibold text-gray-800">Daily Mood Check-in</h3>
                <p className="text-sm text-gray-600">Track how you're feeling today</p>
              </div>
            </div>
            <Link
              to="/mood"
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-800">Talk to AI Counselor</h3>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Schedule encouragement and check-ins</p>
              </div>
            </div>
            <Link
              to="/reminders"
